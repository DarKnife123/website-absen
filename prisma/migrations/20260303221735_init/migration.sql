...
-- CreateEnum
CREATE TYPE "Status" AS ENUM ('hadir', 'sakit', 'izin', 'alpha');
...
-- AddForeignKey
ALTER TABLE "Siswa" ADD CONSTRAINT "Siswa_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
